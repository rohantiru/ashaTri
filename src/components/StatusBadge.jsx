const configs = {
  ...
  ready: { label: 'Ready for Pickup', classes: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
  ...
  interest: { label: 'Interest Poll', classes: 'bg-purple-50 text-purple-700 border-purple-200' },
